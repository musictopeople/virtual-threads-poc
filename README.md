...
The update and delete endpoints still need to be implemented, but there is a React frontend for you to go ahead and wire them up in the backend. Have a blast!
